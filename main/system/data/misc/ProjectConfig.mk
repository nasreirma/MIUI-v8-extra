...
CUSTOM_BUILD_VERNO = CY-X601-H537
...
CUSTOM_HAL_CAM_CAL = gt24c32
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l8xx_mipi_raw ov5695_mipi_raw ov5695_ofilm_mipi_raw
CUSTOM_HAL_LENS = dw9800af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8xx_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800af
CUSTOM_HAL_MSENSORLIB = mmc3524x# mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md hscdtd006 qmc5983 akmd09911 mc64xx bmm056 mc41xx
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS =
CUSTOM_HAL_SUB_IMGSENSOR = ov5695_mipi_raw ov5695_ofilm_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8xx_mipi_raw ov5695_mipi_raw ov5695_ofilm_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8xx_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5695_mipi_raw ov5695_ofilm_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
#zyw modify start : for config modem
#CUSTOM_MODEM = rlk6753_65t_m0_lttg_dsds rlk6753_65t_m0_lwg_dsds
CUSTOM_MODEM = x601_h537_a1_modem
#CUSTOM_MODEM = j5088_lwg_dsds
#zyw modify end
...
MTK_BUILD_VERNO = X601-H537A1-M-161009V73
#alps-mp-m0.mp1-V2.39.1_rlk6753.65u.m0
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
#zyw modify start : for j5080,j5088,j5086 don't surpport TD-SCDMA
#MTK_WORLD_PHONE = yes
MTK_WORLD_PHONE = no
#zyw modify end
...
RLK_CAMERA_GET_OTP_PARAMETERS = yes
#end

#CREATE_PROJECT_INFO=20160223133719
RLK_PROJECT = infinix_x601
RLK_DEVICE_NAME = Infinix NOTE 3 Pro
CONFIG_X601_H537 = yes
RLK_PROJECT_NAME = x601_h537_a1
#add for fingerprint by rulei.zhou 
FINGERPRINT_GOODIX_SUPPORT_GF318M = no
FINGERPRINT_GOODIX_SUPPORT_GF368M = yes
FINGERPRINT_GOODIX_SUPPORT_AFS121 = yes
#miaowei add manual shutter for X601
RLK_CAMERA_MANUAL_SHUTTER_SUPPORT = yes
#miaowei add manual focus for X601
RLK_CAMERA_LOWLIGHT_FACEBEAUTY = yes
RLK_CAMERA_LOWLIGHT = yes
RLK_CAMERA_MANUAL_AF = yes
RLY_AUTO_FACTORY_RST = yes
RLK_SYSTEMUI_2_0_SUPPORT = yes
...
#add for hall simulation clock by lulingjie start
RLK_HALL_SIMULATION_CLOCK_SUPPORT = yes
#add for hall simulation clock by lulingjie end
#wuhao add for hall start
RLK_HALL_SUPPORT = yes
#wuhao add for hall end
